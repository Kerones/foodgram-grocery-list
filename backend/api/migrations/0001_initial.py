# Generated by Django 3.0.5 on 2023-07-29 05:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, message='Чтобы приготовить блюдо нужен хотя бы один ингридиент'), django.core.validators.MaxValueValidator(32767, message='Слишком много ингридиентов!')], verbose_name='Количество')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', colorfield.fields.ColorField(default='#FFFFFF', image_field=None, max_length=18, samples=[('#FFFFFF', 'white'), ('#000000', 'black'), ('#0000FF', 'blue'), ('#FFA500', 'orange'), ('#008000', 'green'), ('#800080', 'purple'), ('#FFFF00', 'yellow')], unique=True, verbose_name='Цвет')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cart', to='api.Recipe', verbose_name='Рецепты')),
